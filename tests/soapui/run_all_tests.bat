...
cd %MY_LOGDIR%
call "C:\Programme portable\SoapUI-5.4.0-EB\bin\testrunner.bat" -PAGS_SERVER_TOKEN=%AGS_SERVER_TOKEN_SECURE% -r -j -f%MY_LOGDIR% %PROJECT_FILE% > %MY_LOGDIR%test_run.log
cd %TEST_DIR%
